...
<?php
	...
	$sorgu=mysqli_query($baglanti,"SELECT ilcelerrr.ilce_ad,ilcelerrr.katilim FROM ilcelerrr WHERE ilcelerrr.katilim>ilcelerrr.ortalama");
?>
...
<script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'İlçelere Göre Ortalamanın Üstündeki Katılım Oranları 2017',
          pieHole: 0.4,
        };
