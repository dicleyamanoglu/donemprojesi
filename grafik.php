...
<?php
	...
	$sorgu=mysqli_query($baglanti,"SELECT oyun_adi,izlenme from sezon_izlenme");
?>
...
<script type="text/javascript">
      ...
      function drawChart() {
		...
		<?php
			...
			echo "['".$row["oyun_adi"]."',".$row["izlenme"]."],";
			}
		?>
      ]);

        
        var options = {'title':'2018-2019 Sezonu Oyunlara Göre İzlenme',
                       'width':500,
                       'height':400,
					   };
...
<div id="chart_div" style=" position:absolute; left:245px; top:140px; "></div>
