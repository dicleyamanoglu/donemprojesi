...
<?php
	...
	$sorgu=mysqli_query($baglanti,"SELECT ay,tam_satis,ogrenci_satis from bilet");
?>
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Aylar', 'Tam Satış', 'Öğrenci Satış'],
           <?php
			foreach($sorgu as $row){
			echo "['".$row["ay"]."',".$row["tam_satis"].",".$row["ogrenci_satis"]."],";
			}
?>
        ]);
...
<div id="chart_div" style= "width:50%; height:50%;left:210px; position:absolute; top:150px;"></div>
</body>
